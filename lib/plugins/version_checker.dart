...
typedef ShowUpdateDialog = void Function(BuildContext context, VersionChecker versionChecker);
...
void _showUpdateDialog(BuildContext context, VersionChecker versionChecker) {
  showDialog(
    context: context,
    ...
    builder: (context) => AlertDialog(
      ...
      content: SingleChildScrollView(
        child: ListBody(
          children: <Widget>[
            Text('Do you want to update to ${versionChecker.storeVersion}?'),
            Text('(current version ${versionChecker.packageVersion})'),
          ],
        ),
      ),
      actions: <Widget>[
        TextButton(
          ...
          onPressed: () async {
            ...
            await versionChecker.launchStore();
          },
        ),
        TextButton(
